...
sidebar_bg(r"/Users/sathish/Desktop/sd2.webp")
set_png_as_page_bg("/Users/sathish/Desktop/bg8.webp")
...
df = pd.read_csv('/Users/Shared/Airbnb/Airbnb_data.csv')
...
#     # Title Image
     ...
     with col2:
        ...
        video_file ="https://www.youtube.com/watch?v=uesPy3Xmfrg"    
...
if selected == "Overview":
    # tab1,tab2 = st.tabs(["$\huge 📝 RAW DATA $", "$\huge🚀 INSIGHTS $"])
        st.title("Few Insights from Airbnb Data")
